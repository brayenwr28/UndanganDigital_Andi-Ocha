        ...
        <div className="space-y-4">
          ...
          >
            <div className="flex justify-center mb-3">
              <img src="/bri.jpg" alt="Logo BRI" className="h-10 md:h-12 object-contain mix-blend-multiply" />
            </div>
            <p className="text-sm font-bold text-[#5c4a3a]">Bank Rakyat Indonesia (BRI)</p>
          ...
          >
            <div className="flex justify-center mb-3">
              <img src="/bsi.png" alt="Logo BSI" className="h-10 md:h-12 object-contain" />
            </div>
            <p className="text-sm font-bold text-[#5c4a3a]">Bank Syariah Indonesia (BSI)</p>
            <p className="text-xs text-[#8b7355] mt-1">Nama Rekening</p>
